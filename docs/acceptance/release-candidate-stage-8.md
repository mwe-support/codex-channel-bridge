...
- The immutable `v0.1.0-rc.2` tag passed the deterministic test suite on GitHub
  but its generic runner correctly reported `codex_not_found` when the host-only
