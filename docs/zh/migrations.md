...
当前 Binary 支持 Bridge Profile Schema 7→8，以及串联的 3、4、5 或 6→8 Path。未知
...
旧 Session，Provider Sequence 可以重新从较小值开始。7→8 为 Outbox 增加持久 WhatsApp Quoted-reply Participant 与 Original-text Field；已有 Record 继续有效，但不具备 Quote。所有 Path 都会验证 Profile
