...
`0.2.0-rc.1` 已包含此实现；当前主线按 Bridge 所负责的流式、响应处理与恢复范围
完成功能验收。实际限流/过期判定由 QQ 决定，未观察的平台条件保留为观察记录，
不承诺固定限额，也不追溯宣称准确发布标签已重新验收。见
[当前边界结论](acceptance/c2c-boundaries-20260910.md#清理与结论)。
