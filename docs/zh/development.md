...
- Profile Store 当前实现持久化、Event-loop 外 Storage Worker、本地多信号 Hybrid Retrieval、Profile-local Archive MCP、Archive Purge、Media Persistence、Profile Purge、Atomic Logical Result Commit 与 Durable Outbox State Transition；显式 Migration 当前只支持已知的 Schema 3 至 10→11，其他 Version Span 继续失败关闭。
